...
public class EscapeFromLabyrinth
{
    ...
    public static void Main()
    {
        ...
        {
            System.Console.WriteLine("No exit!");
        }
        else if (shortestPathToExit == "")
        {
            System.Console.WriteLine("Start is at the exit.");
        }
        else
        {
            System.Console.WriteLine("Shortest exit: " + shortestPathToExit);
        }
    }
    ...
    static string TracePathBack(Point currentCell)
    {
        ...
        while (currentCell.PreviourPoint != null)
        {
            path.Append(currentCell.Direction);
            currentCell = currentCell.PreviourPoint;
        }
    ...
    static bool IsExist(Point currentCell)
    {
