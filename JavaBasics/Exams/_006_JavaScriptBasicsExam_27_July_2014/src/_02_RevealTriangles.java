...
//Най-важният извод от тази задача е, че копирането на един масив в друг не е тривиална задача
//Ако се пробва човек по някакъв интуитивен начин после ще си блъска главата и ще се чуди
//какво става и защо двата масива се държат като един
