define(['models/container', 'models/section', 'models/item'],
    function (Container, Section, Item) {

    var cont = new Container('TODO List');
    cont._addToDOM(document.body);
    ...
    function addNewSection(currElement, inputValue) {
        ...
        if ( errorDiv !== 'error-visible') {
            var currSection = new Section(inputValue);
    ...
    function addNewItem(currElement, inputValue) {
        ...
        var errorDiv = currElement.parentNode.lastChild.className;
        if (errorDiv != 'error-visible') {
            var currItem = new Item(inputValue, 'todo');
