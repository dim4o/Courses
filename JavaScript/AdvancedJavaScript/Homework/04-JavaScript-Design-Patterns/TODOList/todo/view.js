...
(function (scope) {
    ...
    var buildContainerNode = function () {
        var container = new todo._models.Container('TODO List');
        var title = container._value;
        var containerButtonArea = container._inputArea;
        var data = container.getDateString();
